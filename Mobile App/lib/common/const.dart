...
List<Country> COUNTRIES = [
  ...
  Country(id: 14, name: 'Scotland'),
  Country(id: 15, name: 'England'),
  Country(id: 16, name: 'United States'),
  Country(id: 17, name: 'Wales'),
  Country(id: 18, name: 'Republic of Ireland'),
  Country(id: 19, name: 'Bolivia'),
  Country(id: 20, name: 'Switzerland'),
  Country(id: 21, name: 'Uruguay'),
  Country(id: 22, name: 'Mexico'),
  Country(id: 23, name: 'Chile'),
  Country(id: 24, name: 'Turkey'),
  // Country(id: 25, name: 'Panama'),
  Country(id: 26, name: 'Georgia'),
  Country(id: 27, name: 'Paraguay'),
  Country(id: 28, name: 'Slovakia'),
  Country(id: 29, name: 'Peru'),
  Country(id: 30, name: 'Denmark'),
  // Country(id: 31, name: 'Costa Rica'),
  Country(id: 32, name: 'New Zealand'),
  Country(id: 33, name: 'Venezuela'),
  Country(id: 34, name: 'Ecuador'),
  Country(id: 35, name: 'Jamaica'),
  Country(id: 36, name: 'Paraguay'),
  Country(id: 37, name: 'Romania'),
  Country(id: 38, name: 'Hungary'),
  Country(id: 39, name: 'Honduras'),
  Country(id: 40, name: 'Croatia'),
  Country(id: 41, name: 'Australia'),
  Country(id: 42, name: 'Iceland'),
  // Country(id: 43, name: 'Czech Republic'),
  // Country(id: 44, name: 'Zimbabwe'),
  Country(id: 45, name: 'United Arab Emirates'),
  Country(id: 46, name: 'Ukraine'),
  Country(id: 47, name: 'Tunisia'),
  Country(id: 48, name: 'Togo'),
];
